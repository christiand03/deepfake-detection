...
- **Robustheit gegenüber Social-Media-Degradierung (G5).** Reale politische Clips durchlaufen Rekompression, Rauschen und Framerate-Drops; der genutzte Backbone-Verbund ist unter *kombinierter* Degradierung nicht vermessen. Dies motiviert die Robustheits-Simulation in Phase 3.
